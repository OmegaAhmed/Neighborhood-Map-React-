...
class Map extends Component {
  ...
  initSetup = () => {
    ...
    const center = {
      title: 'New Cairo', location: {
        "lat" : 30.0201279,
        "lng" : 31.4981914
      }
    }
    const markers = [
      {title: 'British University in Egypt', location: {
        'lat'  : 30.115553900000002,
        'lng' : 31.611183799999996
      }},
      {title: 'Egyptian Russian University', location: {
        'lat' : 30.14297470403243,
        'lng' : 31.716928482055664
      }},
      {title: 'The American University in Cairo', location: {
        'lat' : 30.01916538794235,
        'lng' : 31.49951934814453
      }},
      {title: 'German University in Cairo', location: {
        'lat' : 29.986757797176153,
        'lng' : 31.441326141357422
      }},
      {title: 'Future University in Egypt', location: {
        'lat' : 30.02719132041361,
        'lng' : 31.491708755493164
      }},
      {title: 'Cairo Festival City', location: {
        'lat' : 30.03152383685598,
        'lng' : 31.408623176969286
      }}
    ]
  ...
  componentDidMount() {
    ...
    loadMapAsync('https://maps.googleapis.com/maps/api/js?key=AIzaSyBnTU9jvEDY7TqDYxRMwBa3pyM8zDUFklc&v=3&callback=initSetup')
  }
